 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://localhost:8585/banque/", wsdlLocation = "http://localhost:8585/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://localhost:8585/banque/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://localhost:8585/banque/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost:8585/banque/", "BanqueServicePort"), BanqueService.class, features);
    }
